define(["require", "exports", "./Event", "localforage"], function (require, exports, Event, localForage) {
    "use strict";
    ...
    class CalendarData {
        ...
        cacheLoadCheckFunc() {
            if (this.eventList != undefined)
                return Promise.resolve();
            //load it from cache
            return localForage.getItem(EVENT_CACHE_KEY).then((events) => {
                if (events == null)
        ...
        syncTokenCheckFunc() {
            ...
            return localForage.getItem(SYNC_CACHE_KEY).then((token) => {
                if (token == null)
        ...
        clearCache() { return localForage.clear(); }
    }
    return CalendarData;
});
