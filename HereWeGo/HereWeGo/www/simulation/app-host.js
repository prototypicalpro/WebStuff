(function e(t, n, r) { function s(o, u) { if (!n[o]) {
    ...
    s(r[o]); return s; })({ 1: [function (require, module, exports) {
        ...
        }, { "./util": 3, "punycode": 12, "querystring": 15 }], 3: [function (require, module, exports) {
            'use strict';
            module.exports = {
            ...
            function setCordovaAndInitialize(originalCordova) {
                var channel, platform, platformBootstrap;
                if (cordova) {
                    return;
                }
        ...
        }, { "./live-reload-client": 5, "./touch-events": 6, "android-platform-core-handlers": "android-platform-core-handlers", "cordova-plugin-device": "cordova-plugin-device", "cordova-plugin-geolocation-clobbers": "cordova-plugin-geolocation-clobbers", "cordova-plugin-inappbrowser-handlers": "cordova-plugin-inappbrowser-handlers", "events": "events", "messages": "messages", "telemetry-helper": "telemetry-helper", "xhr-proxy": "xhr-proxy" }], 5: [function (require, module, exports) {
            var url = require('url');
            ...
            var _lastMouseEvent, _isMouseDown;
            ...
            function _simulateTouchEvent(type, mouseevent) {
                ...
                var listenerName = 'on' + type, simulatedEvent = _createTouchEvent(type, true, true, eventData);
            ...
            InAppBrowser.prototype._prepareUrl = function (url) {
                var queryParameter = 'cdvsim-enabled=false', updatedUrl = url;
            ...
            SystemBrowser.prototype.show = function () {
                if (!this._window) {
                    var modulemapper = cordova.require('cordova/modulemapper'), windowOpen = modulemapper.getOriginalSymbol(window, 'window.open');
            ...
            IframeBrowser.prototype.injectStyleFile = function (callback, args) {
                if (this._container && this._iframe) {
                    var file = args[0], hasCallback = args[1];
                    var code = '(function () {' +
                        'var head = document.getElementsByTagName("head")[0];' +
            ...
            IframeBrowser.prototype._createNavigationBar = function () {
                var navigationDiv = document.createElement('div'), closeSpan = document.createElement('span');
        ...
        }, { "./decode": 13, "./encode": 14 }], "android-platform-core-handlers": [function (require, module, exports) {
            module.exports = {
                'CoreAndroid': {
        ...
        }, { "utils": "utils" }], "cordova-plugin-device": [function (require, module, exports) {
            ...
            var utils = require('utils'), PositionError = require('./PositionError'), Position = require('./Position');
            var timers = {};
            ...
            module.exports = function (messages) {
                var Browser = require('./inapp-browser'), instance;
